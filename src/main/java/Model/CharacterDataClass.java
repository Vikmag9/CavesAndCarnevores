...
public class CharacterDataClass implements CharacterDataCollection{
    ...
    /**
     *Sets the name of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the job of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the name of the race that a character has, in the Model.CharacterDataClass.
    ...
    /**
     * Sets the inventory of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the level of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the background of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the Stats of the character in the Model.CharacterDataClass.
     * @param stats the stats of the character, as a Map of the Model.StatName and Integer with the corresponding stats value.
     * @return the Model.CharacterDataClass object.
     */
    ...
    /**
     * Sets the alignment of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the languages of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the core memories of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the organisations of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the Strength stat of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the Intelligence stat of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the constitution stat of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the wisdom stat of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the charisma stat of the character in the Model.CharacterDataClass.
    ...
    /**
     * Sets the dexterity stat of the character in the Model.CharacterDataClass.
